...
assembly / assemblyShadeRules := Seq(
  ShadeRule.rename("com.fasterxml.**" -> "shadeio.@1")
    .inLibrary(
      ...
      "com.maxmind.geoip2" % "geoip2" % "2.16.1",
...
libraryDependencies += "com.snowplowanalytics" %% "scala-maxmind-iplookups" % "0.8.0"

// https://mvnrepository.com/artifact/com.maxmind.geoip2/geoip2
//libraryDependencies += "com.maxmind.geoip2" % "geoip2" % "2.11.0"
libraryDependencies += "com.maxmind.geoip2" % "geoip2" % "2.16.1"
